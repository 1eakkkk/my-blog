...
const EVENTS = [
    ...
    { rarity: 'common', prob: 50, type: 'empty', msg: "你发现了一个加密文件夹，破解后发现是 20TB 的猫咪视频，发现文件格式损坏，无法传输。" },
    ...
    { rarity: 'common', prob: 55, type: 'reward_coin', min: 55, max: 75, msg: "你路过一家黑客酒吧，随手写了段酷炫代码，顾客们给了你小费。" },
    ...
    { rarity: 'common', prob: 55, type: 'reward_xp', min: 20, max: 40, msg: "系统强制更新，你被迫读了十分钟的更新日志，知识略有增加。" },
    ...
    { rarity: 'legendary', prob: 3, type: 'reward_coin', min: 1314, max: 1314, msg: "🌟🌟🌟你捡到了《三角洲行动》中的“非洲之心”！" },
    { rarity: 'legendary', prob: 1, type: 'reward_coin', min: 2628, max: 2628, msg: "🌟🌟🌟你捡到了《三角洲行动》中的“海洋之泪”！" },
    { rarity: 'legendary', prob: 2, type: 'reward_coin', min: 2480, max: 2480, msg: "🏆你捡到了《暗区突围》中的“机密文件”！" },
    ...
    { rarity: 'legendary', prob: 10, type: 'item_vip',    days: 30, msg: "🌟🌟🌟🌟🌟🌟 [传说] 锦鲤降临！！！你捡到了六百一十五光年之外的【VIP 30天体验卡】！" },
    { rarity: 'legendary', prob: 3, type: 'item', items: ['broadcast_high'],    msg: "[金色传说]你的运气绝无仅有，你在YY-B-0615找到了一张骇客宣言卡！" },
    { rarity: 'legendary', prob: 1, type: 'item', items: ['broadcast_low', 'broadcast_high'],    msg: "不是哥们？你在周炜杰床上找到了【基础信标卡】和【骇客宣言卡】？你到底要干啥？" },

    // ----------------------------------------------------------------
    // 🔴 [Tier 6] 赛博陷阱 (Glitch/Risk)
    // ----------------------------------------------------------------
    { rarity: 'glitch', prob: 40, type: 'glitch', lose_min: 10, lose_max: 30, msg: "⚠️ 遭遇脚本小子攻击，损失了少量维护费。" },
    { rarity: 'glitch', prob: 25, type: 'glitch', lose_min: 50, lose_max: 50, msg: "⚠️ 您已到达贵州：有*不日，罚款50！" },
